...
<head>
   ...
   ================================================== -->
	...
	<!-- CSS
    ================================================== -->
   <link rel="stylesheet" href="<%=webpath %>/example/css/base.css">
	<link rel="stylesheet" href="<%=webpath %>/example/css/main.css">
   <link rel="stylesheet" href="<%=webpath %>/example/css/media-queries.css">         

   <!-- Script
   =================================================== -->
	<script src="<%=webpath %>/example/js/modernizr.js"></script>
...
<body class="homepage">
   ...
   <div id="preloader"> 
	   <div id="status">
         <img src="<%=webpath %>/example/images/loader.gif" height="60" width="60" alt="">
   ...
   <footer>
      ...
      <div class="row">       
         ...
         <p class="copyright">&copy; Copyright 2014 Puremedia. Collect from <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a></p>        
   ...
   <!-- Java Script
   ================================================== -->
   <script src="<%=webpath %>/example/js/jquery.min.js"></script>
   <script>window.jQuery || document.write('<script src="<%=webpath %>/example/js/jquery-1.10.2.min.js"><\/script>')</script>
   <script type="text/javascript" src="<%=webpath %>/example/js/jquery-migrate-1.2.1.min.js"></script>   
   <script src="<%=webpath %>/example/js/jquery.flexslider.js"></script>
   <script src="<%=webpath %>/example/js/jquery.fittext.js"></script>
   <script src="<%=webpath %>/example/js/backstretch.js"></script> 
   <script src="<%=webpath %>/example/js/waypoints.js"></script>  
   <script src="<%=webpath %>/example/js/main.js"></script>
